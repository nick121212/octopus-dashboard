...
INSERT INTO `interface` VALUES (1,'',NULL,'menus/all','GET','','menus-all-fetch','拉取menus的全部数据,包括深度',0,0,1,'null','',1,'2016-03-15 07:05:32','2016-03-15 07:05:32',NULL),(2,'',NULL,'menus','GET','','menus-fetch','拉取menus的全部数据',1,0,1,'null','[{\"field\":\"datas\",\"path\":\"rows\"},{\"field\":\"total\",\"path\":\"count\"}]',1,'2016-03-15 07:05:32','2016-03-15 07:05:32',NULL),(3,'',NULL,'menus/:key/edit','GET','','menus-key-detail','拉取menus中某条详情，搜索条件为key',1,0,1,'null','',1,'2016-03-15 07:05:32','2016-03-15 07:05:32',NULL),(4,'',NULL,'menus','POST','','menus-add','新建menus一条数据',0,1,1,'null','',1,'2016-03-15 07:05:32','2016-03-15 07:05:32',NULL),(5,'',NULL,'menus/:id','DELETE','','menus-id-delete','删除menus中的一条数据',0,0,1,'null','',1,'2016-03-15 07:05:32','2016-03-15 07:05:32',NULL),(6,'',NULL,'menus/:id','PUT','','menus-id-edit','修改menus中的一条数据',0,1,1,'null','',1,'2016-03-15 07:05:32','2016-03-15 07:05:32',NULL),(7,'',NULL,'schemas','GET','','schemas-fetch','拉取schemas中所有数据',1,0,1,'null','[{\"field\":\"datas\",\"path\":\"rows\"},{\"field\":\"total\",\"path\":\"count\"}]',1,'2016-03-15 07:05:32','2016-03-15 07:05:32',NULL),(8,'',NULL,'schemas','POST','','schemas-add','添加schemas中的一条数据',0,1,1,'null','',1,'2016-03-15 07:05:32','2016-03-15 07:05:32',NULL),(9,'',NULL,'schemas/:id','PUT','','schemas-id-edit','修改schemas中的一条数据',0,1,1,'null','',1,'2016-03-15 07:05:32','2016-03-15 07:05:32',NULL),(10,'',NULL,'schemas/:id','DELETE','','schemas-id-delete','修改schemas中的一条数据',0,0,1,'null','',1,'2016-03-15 07:05:32','2016-03-15 07:05:32',NULL),(11,NULL,NULL,'actions','GET',NULL,'actions-fetch','拉取actions的全部数据',1,0,1,NULL,'[{\"field\":\"datas\",\"path\":\"rows\"},{\"field\":\"total\",\"path\":\"count\"}]',1,'0000-00-00 00:00:00','0000-00-00 00:00:00',NULL),(12,NULL,NULL,'actions','POST',NULL,'actions-add','添加actions中的一条数据',0,1,1,NULL,NULL,1,'0000-00-00 00:00:00','0000-00-00 00:00:00',NULL),(13,NULL,NULL,'actions/:id','PUT',NULL,'actions-id-edit','修改actions中的一条数据',0,1,1,NULL,NULL,1,'0000-00-00 00:00:00','0000-00-00 00:00:00',NULL),(14,NULL,NULL,'actions/:id','DELETE',NULL,'actions-id-delete','删除actions中的一条数据',0,1,1,NULL,NULL,1,'0000-00-00 00:00:00','0000-00-00 00:00:00',NULL),(15,NULL,NULL,'interfaces','GET',NULL,'interfaces-fetch','拉取interfaces中所有数据',1,0,1,NULL,'[{\"field\":\"datas\",\"path\":\"rows\"},{\"field\":\"total\",\"path\":\"count\"}]',1,'0000-00-00 00:00:00','0000-00-00 00:00:00',NULL),(16,NULL,NULL,'interfaces','POST',NULL,'interfaces-add','添加interfaces中一条数据',0,1,1,NULL,NULL,1,'0000-00-00 00:00:00','0000-00-00 00:00:00',NULL),(17,NULL,NULL,'interfaces/:id','PUT',NULL,'interfaces-id-edit','修改interfaces中一条数据',0,1,1,NULL,NULL,1,'0000-00-00 00:00:00','0000-00-00 00:00:00',NULL),(18,NULL,NULL,'interfaces/:id','DELETE',NULL,'interfaces-id-delete','删除interfaces中一条数据',0,1,1,NULL,NULL,1,'0000-00-00 00:00:00','0000-00-00 00:00:00',NULL),(20,NULL,NULL,'servers','GET',NULL,'servers-fetch','拉取所有的服务器数据',1,0,1,NULL,'[\n  {\n    \"field\": \"datas\",\n    \"path\": \"rows\"\n  },\n  {\n    \"field\": \"total\",\n    \"path\": \"count\"\n  }\n]',1,'2016-03-16 06:41:22','2016-03-16 06:41:22',NULL),(21,NULL,NULL,'servers','POST',NULL,'servers-add','新建一个服务器信息',0,1,1,NULL,NULL,1,'2016-03-16 06:43:07','2016-03-16 06:43:07',NULL),(22,'',0,'servers/:id','PUT',NULL,'servers-id-edit','修改一个服务器数据',0,1,1,NULL,NULL,1,'2016-03-16 06:43:59','2016-03-16 06:45:15',NULL),(23,NULL,NULL,'servers/:id','DELETE',NULL,'servers-id-delete',NULL,0,0,1,NULL,NULL,1,'2016-03-16 06:44:24','2016-03-16 06:44:24',NULL),(24,NULL,NULL,'/ecms_admin_api/list_posts','GET',NULL,'articles-fetch','拉取所有文章',1,0,1,'{\n  \"page\":\"page\",\n  \"per_page\":\"pageCount\",\n  \"author_id\":\"where.author_id\"\n}','[\n  {\n    \"field\": \"datas\",\n    \"path\": \"posts\"\n  },\n  {\n    \"field\": \"total\",\n    \"path\": \"total\"\n  }\n]',0,'2016-03-16 11:43:17','2016-03-17 04:34:24',1),(25,NULL,NULL,'/ecms_admin_api/add_a_post','POST',NULL,'articles-add','添加一篇文章 post or get',1,1,1,NULL,NULL,0,'2016-03-17 04:33:05','2016-03-17 06:35:26',1),(26,NULL,NULL,'/ecms_ex_api/ue','GET',NULL,'ueditor_config','ueditor接口config地址',1,0,1,'{\n  \"action\": \"action\"\n}',NULL,0,'2016-03-17 08:38:30','2016-03-17 08:38:48',1),(27,NULL,NULL,'/ecms_ex_api/login','POST',NULL,'ecms-login','ecms登录接口',0,1,1,NULL,NULL,0,'2016-03-18 06:24:13','2016-03-18 06:24:13',NULL);
...
INSERT INTO `menu` VALUES (1,'permiss_sy','GM系统','domain',NULL,1,28,NULL,'GM系统',1,'2016-03-15 07:05:32','2016-03-17 09:13:45'),(2,'settings','系统设置','settings',NULL,2,13,'permiss_sy','系统设置',1,'2016-03-15 07:05:32','2016-03-15 07:05:32'),(3,'module','模块管理','view_module','ecms/#/pages/module',3,4,'settings','模块管理',1,'2016-03-15 07:05:32','2016-03-18 07:28:00'),(4,'action','操作管理','note_add','ecms/#/pages/action',5,6,'settings','操作管理',1,'2016-03-15 07:05:32','2016-03-15 09:11:52'),(6,'interface','接口设置','extension','ecms/#/pages/interface',7,8,'settings','接口设置',1,'2016-03-15 07:05:32','2016-03-15 07:05:32'),(7,'schema','SCHEMA设置','wallet_giftcard','ecms/#/pages/schema',9,10,'settings','SCHEMA设置',1,'2016-03-15 07:05:32','2016-03-15 07:05:32'),(8,'server','服务器设置','computer','ecms/#/pages/server',11,12,'settings','服务器设置',1,'2016-03-15 07:05:32','2016-03-16 06:27:50'),(9,'permiss','权限设置','apps',NULL,14,19,'permiss_sy','权限设置',1,'2016-03-15 07:05:32','2016-03-15 07:05:32'),(10,'group','权限组管理','group','ecms/#/pages/group',15,16,'permiss','权限组管理',1,'2016-03-15 07:05:32','2016-03-15 07:05:32'),(11,'actor','角色管理','people_outline','ecms/#/pages/actor',17,18,'permiss','角色管理',1,'2016-03-15 07:05:32','2016-03-15 07:05:32'),(12,'person_set','用户设置','person','',20,23,'permiss_sy','用户设置',1,'2016-03-15 07:05:32','2016-03-15 07:05:32'),(13,'person','用户管理','person_outline','ecms/#/pages/person',21,22,'person_set','用户管理',1,'2016-03-15 07:05:32','2016-03-15 07:05:32'),(14,'article','文章','note_add','',24,27,'permiss_sy','文章管理节点',1,'2016-03-16 11:32:39','2016-03-16 11:35:10'),(15,'articleall','所有文章','note_add','ecms/#/pages/articleall',25,26,'article','文章列表',1,'2016-03-16 11:33:58','2016-03-16 11:40:28');
...
INSERT INTO `server` VALUES (2,'cms-admin-taka','cms-admin服务器','192.168.2.172',3000,'HTTP',1,'cms-admin服务器',1,'2016-03-16 11:26:54','2016-03-16 11:26:54');
...
-- Dump completed on 2016-03-18 15:29:23
